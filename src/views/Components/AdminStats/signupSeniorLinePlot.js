...
class SignUpSeniorLinePlot extends Component {
    constructor(props) {
      super(props);
    ...
    componentDidMount() {
        ...
        db.ref('/adminInfo/signUpRate/2018 National Coding Championships - Senior').on('value', (snapshot) => {
    ...
    handleSelection(value) {
        const db = firebase.database();
        db.ref('/adminInfo/signUpRate/2018 National Coding Championships - Senior/'+value).on('value', (snapshot) => {
...
export default withHighcharts(SignUpSeniorLinePlot, Highcharts); // Injecting the Highcharts object