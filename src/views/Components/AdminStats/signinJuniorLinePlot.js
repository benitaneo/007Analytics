...
class SignInJuniorLinePlot extends Component {
    constructor(props) {
      super(props);
    ...
    componentDidMount() {
        ...
        db.ref('/adminInfo/signInRate/2018 National Coding Championships - Junior').on('value', (snapshot) => {
    ...
    handleSelection(value) {
        const db = firebase.database();
        //console.log(value);
        db.ref('/adminInfo/signInRate/2018 National Coding Championships - Junior/'+value).on('value', (snapshot) => {
...
export default withHighcharts(SignInJuniorLinePlot, Highcharts); // Injecting the Highcharts object