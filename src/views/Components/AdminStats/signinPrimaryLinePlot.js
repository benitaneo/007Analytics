...
class SignInPrimaryLinePlot extends Component {
    constructor(props) {
      super(props);
    ...
    handleSelection(value) {
        const db = firebase.database();
        db.ref('/adminInfo/signInRate/2018 National Coding Championships - Primary/'+value).on('value', (snapshot) => {
...
export default withHighcharts(SignInPrimaryLinePlot, Highcharts); // Injecting the Highcharts object