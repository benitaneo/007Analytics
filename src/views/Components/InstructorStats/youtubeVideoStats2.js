...
class YoutubeLinePlot2 extends Component {
    constructor(props) {
      super(props);
    ...
    componentDidMount() {
      ...
      db.ref('/instructorInfo/videoPause/-L8H-0i0w2y8TTccE6T2').on('value', (snapshot) => {
...
export default withHighcharts(YoutubeLinePlot2, Highcharts); // Injecting the Highcharts object