...
class YoutubeLinePlot3 extends Component {
    constructor(props) {
      super(props);
    ...
    componentDidMount() {
      ...
      db.ref('/instructorInfo/videoPause/-L8H-we7JsrUikMrESh5').on('value', (snapshot) => {
...
export default withHighcharts(YoutubeLinePlot3, Highcharts); // Injecting the Highcharts object